<%-- 
    Document   : cuadrado
    Created on : 26/05/2023, 23:37:56
    Author     : pablo
--%>
...
<html>
    ...
    <body>
        ...
        <h1 align="center">Calcular Perimetro del Cuadrado</h1>
        <form action="">
        ...
        <%
                if(request.getParameter("btnCalcularPerimetro") != null){
                    ...
                    double perimetro = perimetroFactory.calcularPerimetro(lado1, lado2, lado3, lado4, TipoFigura.CUADRADO);
        %>
        ...
        <h1 align="center">Calcular Area del Cuadrado</h1>
        <form action="">
            <table border="1" width="400" align="center">
                <tr>
                    <td>Ingrese la base del Cuadrado:</td>
                    <td><input type="text"  name="txtBase"></td>
                </tr>
                <br>
                <tr>
                    <td>Ingrese la altura del Cuadrado:</td>
        ...
        <%
            ...
            double area = areaFactory.calcularArea(base, altura, 0, TipoFigura.CUADRADO);
        %>
